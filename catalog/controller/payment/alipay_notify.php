...
{	
	...
	$verify_result = $loader->model_payment_alipay->verifyNotify();
	...
	if($verify_result)
	{
		...
		{
			$order_status_id = $config->get("alipay_wait_buyer_pay_status_id");
		}
		...
		{
			$order_status_id = $config->get("alipay_wait_buyer_confirm_goods_status_id");
		}
	...
	else
	{
		...
		{
			$order_status_id = $config->get("alipay_trade_closed_status_id");
		}
		else 
		{
			$order_status_id = $config->get("alipay_trade_error_status_id");
